                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{{route('brand.update',$brand->id)}}" method="POST"
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="name">Brand Image</label>
                                <div class="col-md-9">
                                    ...
                                    <input type="file" name="image" value="{{$brand->brand_image}}">
                                </div>
                            </div>
                            <!-- Form actions -->
                            <div class="form-group">
                                <div class="col-md-12 text-right">
                                    <a class="btn btn-responsive btn-danger btn-sm" href="{{route('brand.index')}}">Back</a>

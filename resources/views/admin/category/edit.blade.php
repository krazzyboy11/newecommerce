                    ...
                    <form class="form-horizontal" action="{{route('category.update',$category->id)}}" method="POST"
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="name">Category Title</label>
                                <div class="col-md-9">
                                    <input id="name" name="title" type="text" placeholder="" class="form-control"
                                    value="{{$category->cat_title}}"></div>
                            </div>
                            {{--<div class="form-group">
                                <label class="col-md-3 control-label" for="name">Category Slug</label>
                                <div class="col-md-9">
                                    <input id="name" name="slug" type="text" placeholder="" class="form-control"></div>
                            </div>--}}
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <input type="file" name="image" value="{{$category->cat_image}}">
                                </div>
                            </div>
                            <!-- Form actions -->
                            <div class="form-group">
                                <div class="col-md-12 text-right">
                                    <a class="btn btn-responsive btn-danger btn-sm" href="{{route('category.index')}}">Back</a>

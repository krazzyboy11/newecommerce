        ...
        <div class="col-md-8 col-md-offset-3 ">
            ...
            <div class="panel panel-primary" id="hidepanel1">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{{route('childcategory.store')}}" method="POST"
                    enctype="multipart/form-data">
                        @csrf
                        <fieldset>

                            <div class="form-group">
                                <label class="col-md-3 control-label" for="name">Child Category Title</label>
                                <div class="col-md-9">
                                    <input id="name" name="childname" type="text" placeholder="" class="form-control"></div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="name">Child Category</label>
                                <div class="col-md-9">
                                    <select name="childcategory" class="form-control">
                                        @foreach($subcategories as $subcategory)
                                        <option value="{{$subcategory->id}}">{{$subcategory->sub_category_name}} ({{$subcategory->category->cat_title}})</option>
                                         @endforeach
                                    </select></div>
                            </div>
                          {{--  <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-12 text-right">
                                    <a class="btn btn-responsive btn-danger btn-sm" href="{{route('childcategory.index')}}">Back</a>

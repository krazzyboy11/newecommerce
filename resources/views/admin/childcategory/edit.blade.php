        ...
        <div class="col-md-8 col-md-offset-3 ">
            ...
            <div class="panel panel-primary" id="hidepanel1">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{{route('childcategory.update',$childcategories->id)}}" method="POST"
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input value="{{$childcategories->child_cat_name}}" id="name" name="childname" type="text" placeholder="" class="form-control"></div>
                            </div>
                            <div class="form-group">

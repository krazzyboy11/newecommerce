    ...
    <div>
        <aside class="right-side">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-lg-12">
                        <a  class="btn btn-info" href="{{route('childcategory.create')}}">Add New</a>
                        ...
                        <div class="panel panel-primary filterable">
                            ...
                            <div class="panel-body table-responsive">
                                <table class="table table-striped table-bordered" id="table2">
                                    ...
                                    <tr>
                                        <td>{{ $key +1 }}</td>
                                        <td>{{$childcategory->child_cat_name}}</td>
                                        <td>{{$childcategory->child_cat_slug}}</td>
                                        <td>
                                            {{$childcategory->subcategory->sub_category_name}} ({{$childcategory->subcategory->category->cat_title}})
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <div></div>
                                                <div class="col-sm-2 text-center">
                                                    <form id="delete-form-{{ $childcategory->id }}" action="{{ route('childcategory.destroy',$childcategory->id) }}" style="display: none;" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                    ...
                                                    <a href="" onclick="if(confirm('Are you sure? You want to delete this?')){
                                                            ...
                                                            document.getElementById('delete-form-{{ $childcategory->id }}').submit();
                                                            }else {
                                                            event.preventDefault();
                                                            }">

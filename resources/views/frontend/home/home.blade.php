...
<div class="container jtv-home-revslider">
    <div class="row">
        <div class="col-lg-9 col-sm-9 col-xs-12 jtv-main-home-slider">
            <div id='rev_slider_1_wrapper' class='rev_slider_wrapper fullwidthbanner-container'>
                <div id='rev_slider_1' class='rev_slider fullwidthabanner'>
                    <ul>
                        <li data-transition='slotzoom-horizontal' data-slotamount='7' data-masterspeed='1000' data-thumb='{{asset('/frontend/images/slider/slide-img1.jpg')}}'><img src='{{asset('/frontend/images/slider/slide-img1.jpg')}}' alt="slider image1" data-bgposition='left top'  data-bgfit='cover' data-bgrepeat='no-repeat'  />
                            <div class="info">
                        ...
                        <li data-transition='slotzoom-horizontal' data-slotamount='7' data-masterspeed='1000' data-thumb='{{asset('/frontend/images/slider/slide-img3.jpg')}}'><img src='{{asset('/frontend/images/slider/slide-img3.jpg')}}' alt="slider image2" data-bgposition='left top'  data-bgfit='cover' data-bgrepeat='no-repeat'  />
                            <div class="info">
                        ...
                        <li data-transition='slotzoom-horizontal' data-slotamount='7' data-masterspeed='1000' data-thumb='{{asset('/frontend/images/slider/slide-img2.jpg')}}'><img src='{{asset('/frontend/images/slider/slide-img2.jpg')}}' alt="slider image3" data-bgposition='left top'  data-bgfit='cover' data-bgrepeat='no-repeat'  />
                            <div class="info">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            <div class="banner-block"> <a href="#"> <img src="{{asset('/frontend/images/banner1.jpg')}}" alt=""> </a>
                                ...
                                <div class="slider-items slider-width-col4 products-grid">
                                    ...
                                    <div class="item">
                                        <div class="item-inner">
                                            <div class="item-img">
                                                <div class="item-img-info"><a class="product-image" title="{{$featureProduct->product_name}}" href="product-detail.html"> <img alt="{{$featureProduct->prdouct_name}}" src="{{asset('uploads/ProductImage/'.$featureProduct->product_image)}}"> </a>
                                            ...
                                            <div class="item-info">
                                                <div class="info-inner">
                                                    <div class="item-title"> <a title="{{$featureProduct->product_name}}" href="{{route('product_details',['id'=>$featureProduct->id])}}">{{$featureProduct->product_name}}</a> </div>
                                                    <div class="item-content">
                                                        <div class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <i class="fa fa-star-o"></i> </div>
                                                        <div class="item-price">
                                                            <div class="price-box"> <span class="regular-price"> <span class="price">${{$featureProduct->product_regular_price}}</span></span>
                                                                <p class="old-price"> <span class="price-label">Regular Price:</span>@if($featureProduct->product_sale_price) <span class="price"> ${{$featureProduct->product_sale_price}}</span> @endif</p>
                                                            </div>
                                                        </div>
                                                        <div class="actions">
                                                            <div class="add_cart">
                                    ...
                                    {{--<div class="item">
                                        <div class="item-inner">
                                            <div class="item-img">
                                                <div class="item-img-info"><a class="product-image" title="Product tilte is here" href="product-detail.html"> <img alt="Product tilte is here" src="{{asset('/frontend/images/products/product-fashion-1.jpg')}}"> </a>
                                                    <div class="mask-shop-white"></div>
                                                    <a class="quickview-btn" href="quick-view.html"><span>Quick View</span></a> <a href="wishlist.html">
                                                        <div class="mask-left-shop"><i class="fa fa-heart"></i></div>
                                                    </a> <a href="compare.html">
                        ...
                        <div class="blog-outer-container">
                            <div class="blog-inner">
                                <div class="col-xs-12 col-sm-4 blog-preview_item">
                                    <div class="entry-thumb jtv-blog-img-hover"> <a href="blog_single_post.html"> <img alt="Blog" src="{{asset('/frontend/images/blog-img1.jpg')}}"> </a> </div>
...
<div class="jtv-collection-area">
    <div class="container">
        <div class="column-right pull-left col-sm-4 no-padding"> <a href="#"> <img src="{{asset('/frontend/images/women-top.jpg')}}" alt="Top Collections"> </a>
        ...
        <div class="column-left pull-right col-sm-8 no-padding">
            <div class="column-left-top">
                <div class="col-left-top-left pull-left col-sm-8 no-padding"> <a href="#"> <img src="{{asset('/frontend/images/men-suits.jpg')}}" alt="Men's Suits"> </a>
                ...
                <div class="col-left-top-right pull-right col-sm-4 no-padding"> <a href="#"> <img src="{{asset('/frontend/images/footwear.jpg')}}" alt="footwear"> </a>
            ...
            <div class="column-left-bottom col-sm-12 no-padding">
                <div class="col-left-bottom-left pull-left col-sm-4 no-padding"> <a href="#"> <img src="{{asset('/frontend/images/handbag.jpg')}}" alt="Handbag"> </a>
                ...
                <div class="col-left-bottom-right pull-right col-sm-8 no-padding"> <a href="#"> <img src="{{asset('/frontend/images/watch-banner.jpg')}}" alt="Watch"> </a>
    ...
    <div class="row">
            ...
            <div class="jtv-hot-deal-product">
                ...
                <ul class="products-grid">
                    <li class="right-space two-height item">
                        <div class="item-inner">
                            <div class="item-img">
                                <div class="item-img-info"><a href="#" title="Product tilte is here" class="product-image"><img src="{{asset('/frontend/images/products/product-fashion-1.jpg')}}" alt="Product tilte is here"> </a>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 hidden-sm">
            <div class="sidebar-banner">
                <div class="jtv-top-banner"> <a href="#"> <img src="{{asset('/frontend/images/banner3.jpg')}}" alt="banner"> </a> </div>
                <div class="jtv-top-banner"> <a href="#"> <img src="{{asset('/frontend/images/banner2.jpg')}}" alt="banner"> </a> </div></div>
        </div>
        <!-- Top Seller Slider -->
        <div class="col-sm-4 col-xs-12">
        ...
        <div class="slider-items-products">
            <div id="jtv-brand-logo-slider" class="product-flexslider hidden-buttons">
                <div class="slider-items slider-width-col6">
                    <div class="item"><a href="#"><img src="{{asset('/frontend/images/brand1.png')}}" alt="Brand Logo"></a> </div>
                    <div class="item"><a href="#"><img src="{{asset('/frontend/images/brand1.png')}}" alt="Brand Logo"></a> </div>
                    <div class="item"><a href="#"><img src="{{asset('/frontend/images/brand1.png')}}" alt="Brand Logo"></a> </div>
                    <div class="item"><a href="#"><img src="{{asset('/frontend/images/brand1.png')}}" alt="Brand Logo"></a> </div>
                    <div class="item"><a href="#"><img src="{{asset('/frontend/images/brand1.png')}}" alt="Brand Logo"></a> </div>

                                                    ...
                                                    <div class="popup">
                                                        <div class="row">
                                                            <div class="col-md-4 col-sm-6">
                                                               @foreach($category->subcategories->slice(0,2) as $subcategory)
                                                                <h3><a href="">{{$subcategory->sub_category_name}}</a></h3>
                                                                <ul class="nav">
                                                                    @foreach($subcategory->childcategories as $childcategory)
                                                                    <li><a href="{{route('category_product',['id'=>$childcategory->id])}}">{{$childcategory->child_cat_name}}</a></li>
                                                                    @endforeach
                                                            ...
                                                            <div class="col-md-4 col-sm-6 has-sep">
                                                                @foreach($category->subcategories->slice(2,4) as $subcategory)
                                                                    <h3><a href="">{{$subcategory->sub_category_name}}</a></h3>
                                                                    <ul class="nav">
                                                                        @foreach($subcategory->childcategories as $childcategory)
                                                                            <li><a href="{{route('category_product',['id'=>$childcategory->id])}}">{{$childcategory->child_cat_name}}</a></li>

            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-sm-3 col-xs-12">
                        <div class="logo"><a title="ecommerce" href="\"><img alt="ecommerce" src="{{asset('frontend/images/logo.png')}}"></a></div>
                        <div class="nav-icon">
                            <div class="mega-container visible-lg visible-md visible-sm">
                                <div class="navleft-container">
                                    ...
                                    <div class="mega-menu-category">
                                                    ...
                                                    <div class="popup">
                                                        <div class="row">
                                                            <div class="col-md-4 col-sm-6">
                                                                <h3><a href="{{route('category_product')}}">Clothing</a></h3>
                                                                <ul class="nav">
                                                                    @foreach($categoires as $category)
                                                                    <li><a href="shop-grid-sidebar.html">{{$category->id}}</a></li>
                                                                    @endforeach
                                                                    <li><a href="shop-grid-sidebar.html">Shirts</a></li>
                                                                    <li><a href="shop-grid-sidebar.html">Trousers</a></li>
                                                                    <li><a href="shop-grid-sidebar.html">Sleep Wear</a></li>
                                                            ...
                                                            <div class="col-md-4 has-sep hidden-sm">
                                                                <div class="custom-menu-right">
                                                                    <div class="box-banner media">
                                                                        <div class="add-right"><a href="#"><img src="{{asset('/frontend/images/jtv-menu-banner1.jpg')}}" class="img-responsive" alt="New Arrive"></a></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <br>
                                                        <a href="#" class="ads"><img src="{{asset('/frontend/images/jtv-menu-banner4.jpg')}}" alt="Mega Sale" class="img-responsive"></a> </div>
                                                </div>
                                            </li>
                                            <li><a href="#">Women's</a>
                                                <div class="wrap-popup">
                                                            ...
                                                            <div class="col-md-4 has-sep hidden-sm">
                                                                <div class="custom-menu-right">
                                                                    <div class="box-banner media">
                                                                        ...
                                                                        <div class="add-right"><img src="{{asset('/frontend/images/jtv-menu-banner2.jpg')}}" alt="Top Glass" class="img-responsive"></div>
                                                                    </div>
                                                                    <div class="box-banner media">
                                                                        <div class="add-desc">
                                                                            <h3>Save</h3>
                                                                        ...
                                                                        <div class="add-right"><img src="{{asset('/frontend/images/jtv-menu-banner3.jpg')}}" alt="Save 35%" class="img-responsive"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="side-banner"><img src="{{asset('/frontend/images/top-banner.jpg')}}" alt="Flash Sale" class="img-responsive"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
              ...
              New York, USA</span>
                    ...
                    <div class="col-xs-12 col-lg-3 col-md-4 col-sm-6">
                        ...
                        <div class="payment-accept">
                            ...
                            <div class="payment-icon"><img src="{{asset('/frontend/images/paypal.png')}}" alt="paypal"> <img src="{{asset('/frontend/images/visa.png')}}" alt="visa"> <img src="{{asset('/frontend/images/american-exp.png')}}" alt="american express"> <img src="{{asset('/frontend/images/mastercard.png')}}" alt="mastercard"></div>
                        </div>
                    </div>
                </div>
            </div>

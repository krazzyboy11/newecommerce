            ...
            <div class="col-sm-9 col-xs-12">
                <div class="product-view">
                    <div class="product-essential">
                        <form action="{{route('add-to-cart')}}" method="post" id="product_addtocart_form">
                            @csrf
                            <div class="product-img-box col-lg-5 col-sm-5 col-xs-12">
                                <div class="product-image">
                                    <div class="product-full">
                                        <div class="new-label new-top-left"> New </div>
                                        <img id="product-zoom" src="{{asset('uploads/ProductImage/'.$productDetails->product_image)}}" data-zoom-image="{{asset('uploads/ProductImage/'.$productDetails->product_image)}}" alt="product-image"/>
                                    </div>
                            ...
                            <div class="product-shop col-lg-7 col-sm-7 col-xs-12">
                                ...
                                <div class="price-block">
                                    <div class="price-box">
                                        @if($productDetails->product_sale_price)
                                        <p class="special-price"> <span class="price-label">Special Price</span><span class="price"> ${{$productDetails->product_sale_price}} </span></p>
                                        <p class="old-price"> <span class="price-label">Regular Price:</span><span class="price"> ${{$productDetails->product_regular_price}} </span></p>
                                        @else
                                            <p class="special-price"> <span class="price-label">Special Price</span><span class="price"> ${{$productDetails->product_regular_price}} </span></p>
                                        @endif
...
{{--
                                        <input  value="Add to Cart" type="submit" class="button btn-cart" >
--}}
